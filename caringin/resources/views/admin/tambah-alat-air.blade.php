...
@section('content')
       ...
       <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-center">
          <h1 class="h3 mb-0 text-gray-800">Tambah Alat Air</h1>
        </div>

        <div class="row justify-content-center">
          <div class="col-lg-6">
            <div class="p-4">
              <form class="user" action="storealatair" method="POST">
              @csrf
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="meteranair" class="form-control form-control-user" id="exampleInputMeteran" placeholder="123xx">
                </div>
