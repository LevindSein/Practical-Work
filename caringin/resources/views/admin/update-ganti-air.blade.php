        ...
        <div class="row justify-content-center">
          <div class="col-lg-6">
            ...
            @foreach ($dataset as $data)
              <form class="user" action="{{url('update/storegantialatair',[$data->ID_TEMPAT])}}" method="POST">
              @csrf
                ...
                <div class="form-group">
                  ID Meteran Lama
                  <input readonly value="{{$data->ID_MAIR}}" type="number" name="idMAirLama" class="form-control form-control-user" id="exampleInputMAirLama" placeholder="(kosong)">
                </div>
                <div class="form-group">
                  Nomor Meteran Lama
                  <input readonly value="{{$data->NOMTR_AIR}}" type="text" name="noMAirLama" class="form-control form-control-user" id="exampleInputNoAirLama" placeholder="(kosong)">
                </div>
                <div class="form-group">
                  ID Meteran Baru
