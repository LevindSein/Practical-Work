...
<head>
  ...
  <title>Data Tagihan Nasabah</title>
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTagihan" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="tagihan-air.html">Tagihan Air</a>
            <a class="collapse-item" href="tagihan-listrik.html">Tagihan Listrik</a>
            <a class="collapse-item" href="tagihan-kebersihan.html">Tagihan Kebersihan</a>
            <a class="collapse-item" href="tagihan-keamanan.html">Tagihan IPK & Keamanan</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTarif" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <div class="collapse-divider"></div>
            <a class="collapse-item" href="tarif-air.html">Tarif Air</a>
            <a class="collapse-item" href="tarif-listrik.html">Tarif Listrik</a>
            <a class="collapse-item" href="tarif-kebersihan.html">Tarif Kebersihan</a>
            <a class="collapse-item" href="tarif-ipk.html">Tarif IPK</a>
            <a class="collapse-item" href="tarif-keamanan.html">Tarif Keamanan</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <div class="collapse-divider"></div>
            <a class="collapse-item" href="laporan-harian.html">Laporan Harian</a>
            <a class="collapse-item" href="laporan-bulanan.html">Laporan Bulanan</a>
            <a class="collapse-item" href="laporan-tahunan.html">Laporan Tahunan</a>
            <a class="collapse-item" href="laporan-tagihan.html">Laporan Tagihan</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseNasabah" class="collapse" aria-labelledby="headingNasabah" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="tambah-nasabah.html">Tambah Nasabah</a>
            <a class="collapse-item" href="data-nasabah.html">Data Nasabah</a>
          </div>
        </div>
      </li>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Data Tagihan Nasabah</h1>
            <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Print Tagihan</a>
          </div>

          <!-- Data LAPORAN -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Tabel Data Tagihan</h6>
                <p></p>
                <label for="sel1">(Kode Kontrol Nasabah disini)</label>
                <p></p>
                <label for="sel1">(Nama Nasabah disini)</label>
                <p></p>
