    ...
    <main>
      <table class="tg">
          ...
          <tr>
            ...
            <td class="tg-g25h">{{number_format($d[$j]->TTL_KEBERSIHAN)}}</td>
            <td class="tg-g25h">{{number_format($d[$j]->REALISASI_KEBERSIHAN)}}</td>
            <td class="tg-g25h">{{number_format($d[$j]->SELISIH_KEBERSIHAN)}}</td>
          </tr>

          <?php
          $alamatku = $alamatku + $d[$j]->JML_ALAMAT;
          $tagihanku = $tagihanku + $d[$j]->TTL_KEBERSIHAN;
          $realisasiku = $realisasiku + $d[$j]->REALISASI_KEBERSIHAN;
          $selisihku = $selisihku + $d[$j]->SELISIH_KEBERSIHAN;
          ?>
          @endfor
          <tr>
