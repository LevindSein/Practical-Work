                ...
                <li class="nav-item">
                    ...
                    <div
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="{{url('showpenerimaanharian')}}">Pendapatan Harian</a>
                            <a class="collapse-item" href="{{url('showpenerimaanbulanan')}}">Pendapatan Bulanan</a>
                            <a class="collapse-item" href="{{url('showpendapatantahunan')}}">Pendapatan Tahunan</a>
                        </div>
                    </div>
                </li>
